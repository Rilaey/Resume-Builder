...
const projectQuestions = [
    ...
    },
    {
        type: "input",
        name: "keyItemOne",
        message: chalk.blue("Please enter your first bullet point of this project."),
        validate: (keyItemOne) => {
            if(!keyItemOne) {
                log(chalk.red("/// PLEASE INPUT YOUR FIRST BULLET POINT FOR THIS PROJECT ///"))
            } else {
                return true
            }
        }
    },
    {
        type: "input",
        name: "keyItemTwo",
        message: chalk.blue("Please enter your second bullet point of this project. IF NO MORE BULLET POINTS ENTER NONE"),
        validate: async (keyItemTwo) => {
            if(!keyItemTwo) {
                log(chalk.red("/// PLEASE INPUT YOUR SECOND BULLET POINT FOR THIS PROJECT ///"))
