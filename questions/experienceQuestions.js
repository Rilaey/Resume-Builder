...
const experienceQuestions = [
    ...
    },
    {
        type: "input",
        name: "startYear",
        message: chalk.magenta("What year did you start here? Please type in 4 digit format."),
        validate: (startYear) => {
            if(!startYear) {
    ...
    },
    {
        type: "input",
        name: "endYear",
        message: chalk.magenta("What year did you stop working here? If currently employed here type Present"),
        validate: (endYear) => {
            if(!endYear) {
    ...
    },
    {
        type: "input",
        name: "jobKeyPointOne",
        message: chalk.magenta("What is your first key accomplishment at this company?"),
